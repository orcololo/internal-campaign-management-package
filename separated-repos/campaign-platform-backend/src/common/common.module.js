...
var mock_auth_service_1 = require("./mock-auth.service");
var viacep_service_1 = require("./services/viacep.service");
/**
 * Common Module
 *
...
var CommonModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [mock_auth_service_1.MockAuthService, viacep_service_1.ViaCepService],
            exports: [mock_auth_service_1.MockAuthService, viacep_service_1.ViaCepService],
        })];
